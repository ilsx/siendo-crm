...
*
*/
define('APP_BASE_URL', 'https://app2.siendogroup.com/');
...
*/
define('APP_ENC_KEY', '87b87269faac96a6aaec43df4c1610f2');
 ...
 */
define('APP_DB_USERNAME', 'dockercrm');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'COil4r7gTAdntStW');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'dockercrm');
